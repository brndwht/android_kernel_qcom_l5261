...
//BEGIN<REQ><FCEBL-64><20150901>Add store camera  info;xiongdajun 
#ifdef CONFIG_DEV_INFO
	if((!strncmp(slave_info->sensor_name, "ov5648_q5v22e_darling_l5261", sizeof("ov5648_q5v22e_darling_l5261")))
        ||(!strncmp(slave_info->sensor_name, "ov5648_q5v22e_darling_l5421", sizeof("ov5648_q5v22e_darling_l5421"))))
	{
		rc = snprintf(sub_camera_and_eeprom, DEV_INFO_LEN, "%s_(5M | interp:null)", 
			"ov5648_q5v22e_darling");		
		if(rc < 0){
       ...
       else if((!strncmp(slave_info->sensor_name, "ov5648_q5v22e_qtech_l5261", sizeof("ov5648_q5v22e_qtech_l5261")))
        ||(!strncmp(slave_info->sensor_name, "ov5648_q5v22e_qtech_l5421", sizeof("ov5648_q5v22e_qtech_l5421"))))
	{
		rc = snprintf(sub_camera_and_eeprom, DEV_INFO_LEN, "%s_(5M | interp:null)", 
			"ov5648_q5v22e_sunwin");
		if(rc < 0){
			store_sub_camera_info(slave_info->sensor_name);
		}else{
			store_sub_camera_info(sub_camera_and_eeprom);
       ...
       else if((!strncmp(slave_info->sensor_name, "ov13850_l5261", sizeof("ov13850_l5261")))
        ||(!strncmp(slave_info->sensor_name, "ov13850_l5421", sizeof("ov13850_l5421"))))
	{
	        if(!strncmp(s_ctrl->sensordata->eeprom_name, "liteon_q13v06k", sizeof("liteon_q13v06k"))){
			//store_sub_camera_eeprom_info("DaLing");

			rc = snprintf(main_camera_and_eeprom, DEV_INFO_LEN, "%s_(13M | interp:null)", 
					"ov13850_Liteon");		
		}
		if(rc < 0){
